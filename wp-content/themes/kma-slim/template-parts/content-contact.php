                            ...
                            <div class="column is-12">
                                ...
                                <p class="title is-5 phone">
                                    <a href="tel:<?= PageField::getField('contact_info_phone_number', 58); ?>">
                                        ...
                                        </span> <?= PageField::getField('contact_info_phone_number', 58); ?></a></p>
                                <p class="title is-5 hours">
                                    <span class="icon">
                                        <i aria-hidden="true" class="fa fa-clock-o"></i>
                                    </span> <?= PageField::getField('contact_info_hours', 58); ?></p>
                                <p></p>
                            </div>
                            <div class="column is-12 is-6-desktop">
                                ...
                                <google-map :latitude="30.182326" :longitude="-85.8077277" :zoom="15" name="ww">
                                    <pin :latitude="30.182326" :longitude="-85.8077277" title="The Wicked Wheel">
                                        ...
                                        <p class="address"><?= nl2br(PageField::getField('contact_info_address', 58)); ?></p>
